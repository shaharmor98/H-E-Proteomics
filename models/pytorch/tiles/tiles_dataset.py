...
class TilesDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print("img_path: {}, index {}".format(img_path, index))
        ...
        if morph_features.shape != torch.Size([3, 224, 224]):
            print("img name {} morph shape: {}".format(tile_slide_name, morph_features.shape))
